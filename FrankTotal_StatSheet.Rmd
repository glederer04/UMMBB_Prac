...
#data
```{r}
table_subtitle <- paste0("Full Season | Complete Totals")
save_name <- paste0("Full Season - Frank Total Stat Sheet.png")
```
...
frank_table <- frank %>%
  ...
  tab_header(title = md('**Total Practice Stat Sheet**'), subtitle = paste0(table_subtitle)) %>%
