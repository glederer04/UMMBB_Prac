...
#input
```{r}
table_subtitle1 <- paste0("Full Season | Complete Totals")
table_subtitle2 <- paste0("Full Season | Basic Totals")
table_subtitle3 <- paste0("Full Season | Advanced Totals")
save_name1 <- paste0("Full Season - Complete Totals Stat Sheet.png")
save_name2 <- paste0("Full Season - Basic Totals Stat Sheet.png")
save_name3 <- paste0("Full Season - Advanced Totals Stat Sheet.png")
```
